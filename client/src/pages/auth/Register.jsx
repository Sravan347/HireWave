...
export default function CandidateRegister() {
  ...
  const validate = (field, value) => {
    ...
    switch (field) {
      ...
      case "age":
        ...
        else if (value < 18 || value > 60) err = "Age must be between 18 and 60.";
        break;
      case "place":
  ...
  return (
    <div className="max-w-xl mx-auto mt-12 p-6 bg-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold text-center text-[#2563EB] mb-6">Candidate Registration</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-gradient-to-r from-[#2563EB] to-[#3B82F6] text-white py-2 rounded hover:shadow-lg transition"
        >
          Register
        </button>
      </form>
